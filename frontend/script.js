(function($) {
    ...
    const PetFlowConfig = {
        tempoEspera: 10000,
        tempoAtendimento: 15000,
        intervaloChecagem: 2000
    };
    ...
    $(document).ready(function() {
        ...
        $('.kanban-board').on('click', '.btn-avancar', function() {
        ...
        setInterval(function() {
            verificarAtrasos('#coluna-espera', PetFlowConfig.tempoEspera);
            verificarAtrasos('#coluna-banho', PetFlowConfig.tempoAtendimento);
        }, PetFlowConfig.intervaloChecagem);
    });
